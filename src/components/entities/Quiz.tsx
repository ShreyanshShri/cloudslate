...
const Quiz = ({data, index}: props) => {
    ...
    const [optionsList, setOptionsList] = useState<Array<option>>(data.optionsList.map((opt: any) => ({text: opt.text, isCorrect: false})));
    ...
    return (
        ...
        <div className="quiz-body">
            ...
            <button onClick={submitAnswer} className="quiz-submit">Submit</button>
        </div>
    </div>
  )
}
