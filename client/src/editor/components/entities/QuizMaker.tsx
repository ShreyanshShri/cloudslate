			...
			<div id="quiz-maker-container">
				<div id="quiz-maker-header">
					...
					<span
						...
						onClick={() => setDisplayQuizMaker(false)}
					>
					...
					<div id="quiz-maker-options-list">
						<div id="quiz-maker-add-option">
							...
							<div id="quiz-maker-add-option-wrapper">
								...
								/>
								<button className="quiz-submit m-0" onClick={addOption}>
									Add
								</button>
							</div>
						...
						{optionsList.map((option: any, index: number) => (
							...
							<OptionsDiv
								...
								data={option}
								index={index}
								updateCurrentOption={updateCorrectOption}
								isRed={null}
								isGreen={null}
							/>
						))}
					</div>
					<button className="quiz-submit" onClick={createQuiz}>
						Submit
					</button>
				</div>
			</div>
